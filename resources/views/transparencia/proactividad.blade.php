        ...
        <div class="row inner-team-sec1 padding-bottom" >
            <div class="col-12 col-lg-4 text-center text-lg-left">
                <div class="team-detail wow fadeInLeft">
                    <h4 class="heading" style="font-size: 45px;">PROACTIVIDAD<span style="font-size: 40px; font-weight:lighter;"></span></h4>
                </div>
            </div>
                        ...
                        <div class="item text-center">
                            <div class="team-box">
                                ...
                                <div class="team-detail wow fadeInRight">
                                    <h4 class="team-spec" style="color: white; text-align: justify; vertical-align: middle;">La transparencia proactiva es la información que voluntariamente los Sujetos Obligados ponen a disposición de los ciudadanos, es decir, es el conjunto de actividades e iniciativas ordenadas que van más allá de las obligaciones que marca la ley.</h4>
            ...
            <div class="row">
                ...
                <div class="title-hr" ><div class="title-hr2" ></div></div>
                    ...
                    <div id="js-grid-mosaic" class="cbp cbp-l-grid-mosaic" style="margin-left: 0%;">
                            ...
                            <a target="blank" href="{{ asset('pdf\proactividad\1. Infografía Derechos ARCO.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\1.InfografíaDerechosARCO-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografía derechos ARCO.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\2. Infografía Solicitud de Derechos ARCO.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\2. Infografía Solicitud de Derechos ARCO-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografía solicitud de derechos ARCO.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\3. Infografía procedimiento de derechos ARCO.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\3. Infografía procedimiento de derechos ARCO-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografía procedimiento de derechos ARCO.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                         ...
                         <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\4. infografia Mecanismo de defensa Derechos ARCO.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\4. infografia Mecanismo de defensa Derechos-thumb ARCO.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografia mecanismo de defensa derechos ARCO.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                         ...
                         <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\5. infografía Recurso de Revisión.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\5. infografía Recurso de Revisión-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografía recurso de revisión.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                         ...
                         <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\6. RECURSO DE INCONFORMIDAD.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\6. RECURSO DE INCONFORMIDAD-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Recurso de inconformidad.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                         ...
                         <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\7.FUNCIONES ÁREA DE CORRESPONDENCIA.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\7.FUNCIONES ÁREA DE CORRESPONDENCIA-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Funciones área de Correspondencia.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                         ...
                         <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\8.infografia archivo de concentración.jpeg')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="{{ asset('pdf\proactividad\8.infografia archivo de concentración.jpeg')}}"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografia archivo de concentración.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                          ...
                          <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\9.Infografia archivo de trámite.jpeg')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="{{ asset('pdf\proactividad\9.Infografia archivo de trámite.jpeg')}}"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                            ...
                            <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\10.Infografía Área Coordinadora de Archivos.jpeg')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\10.Infografía Área Coordinadora de Archivos-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografía área coordinadora de archivos.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                          ...
                          <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\11.Infografia SIA.jpeg')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\11.Infografia SIA-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Infografia SIA.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                         ...
                         <div class="cbp-item web logo" style="max-width: 200px;">
                            <a target="blank" href="{{ asset('pdf\proactividad\12.LINEAMIENTOS PARA LA INTEGRACION DE EXPEDIENTES actualizado.pdf')}}" class="cbp-caption" data-title="">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="images\12.LINEAMIENTOS PARA LA INTEGRACION DE EXPEDIENTES actualizado-thumb.jpg"  alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <!-- <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                      <!--  <h4 class="p-hover-title">GUÍA ORIENTADORA</h4> -->
                                        <p class="p-hover-des">Lineamientos para la integración de expedientes.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
